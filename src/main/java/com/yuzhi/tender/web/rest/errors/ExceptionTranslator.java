package com.yuzhi.tender.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.yuzhi.tender.service.EmailAlreadyUsedException ||
            ex instanceof com.yuzhi.tender.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof com.yuzhi.tender.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.yuzhi.tender");
    }
}

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bid-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BIDINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_BIDINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BIDINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BIDINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BIDINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BIDINFO actions', async () => {
      const expectedActions = [
        {
